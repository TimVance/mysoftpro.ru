...
{
	$arResult["OG"]["TITLE"] = $arResult["PROPERTIES"]["OG_TITLE"]["VALUE"];
}
else
{
...
{
	$arResult["OG"]["DESCRIPTION"] = $arResult["PROPERTIES"]["OG_DESCRIPTION"]["VALUE"];
}

if(!empty($arResult["PROPERTIES"]["OG_IMAGE"]["VALUE"]))
{
	$arResult["OG"]["IMAGE"] = 'https://'.SITE_SERVER_NAME.CFile::GetPath($arResult["PROPERTIES"]["OG_IMAGE"]["VALUE"]);
}
elseif(!empty($arResult["DETAIL_PICTURE"]["SRC"]))
{
	$arResult["OG"]["IMAGE"] = 'https://'.SITE_SERVER_NAME.$arResult["DETAIL_PICTURE"]["SRC"];
}

if(!empty($arResult["PROPERTIES"]["OG_SITE_NAME"]["VALUE"]))
{
	$arResult["OG"]["SITE_NAME"] = $arResult["PROPERTIES"]["OG_SITE_NAME"]["VALUE"];
}

$this->__component->SetResultCacheKeys(['PREVIEW_PICTURE', 'DETAIL_PICTURE', 'OG']);