...
<div class="ns-bitrix c-catalog c-catalog-catalog-1 p-element">
    ...
    <?php if ($arElement['SHOW']) { ?>
        <?php
	        //PROPERTY_OFFICE_VERSION
// 	        $arElement['PARAMETERS']['PROPERTY_CODE'][] = 'PROPERTY_OFFICE_VERSION';
// 	        echo "<pre>".print_r($arElement['PARAMETERS'], 1)."</pre>";
    ...
    <?php if(CModule::IncludeModule("arturgolubev.ecommerce")){
