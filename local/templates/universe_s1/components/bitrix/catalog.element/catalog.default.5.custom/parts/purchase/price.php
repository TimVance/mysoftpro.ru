    ...
    <div class="catalog-element-price">
        <div class="catalog-element-price-current catalog-element-price-part">
            <? if ($arPrice['PRICE'] == 0): ?>
                <? echo 'По запросу'; ?>
            <? else: ?>
                <span class="catalog-element-price-current-value" data-role="price.discount" itemprop="price" content="<?=$arPrice['PRICE']?>">
                    <?= !empty($arPrice) ? $arPrice['PRINT_PRICE'] : null ?>
                </span>
            <? endif; ?>
			<meta itemprop="priceCurrency" content="<?=$arPrice['CURRENCY']?>">
            <span <? if ($arPrice['PRICE'] == 0) echo 'style="display:none"'; ?> class="catalog-element-price-current-separator">/</span>
            <span <? if ($arPrice['PRICE'] == 0) echo 'style="display:none"'; ?> class="catalog-element-price-current-measure" data-role="price.measure">
