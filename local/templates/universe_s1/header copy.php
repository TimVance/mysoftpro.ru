...
<html lang="<?=LANGUAGE_ID?>">
    <head>
        ...
        <?php $APPLICATION->IncludeFile('/include/header/header_end_counter.php'); ?>
        
        <?php if($APPLICATION->GetCurDir() == "/") $APPLICATION->IncludeFile('/include/header/main_header_end_counter.php'); ?>
